#Welcome to my python program ver 2.1
...
""">>>Patch Notes<<<:1.Added functionality to deal with negate statements.
		     ...
		     4.Increased the speed of vocal ticks."""
...
print("------------------------------->>> Welcome To Pied Piper Assistant Wizard v2.1 <<<-------------------------------",end='')
print("_________________________________________________________________________________________________________________")
pyttsx3.speak("Welcome to Pied Piper Assistant Wizard Version 2 point 1!")
...
while done!=1 :
	...
	if(("human" in p) or ("bad" in p) or ("married" in p) or ("robot" in p) or ("old" in p) or ("single" in p)):
		...
		pyttsx3.speak("Chatting features will be introduced in the version 1 point of this program")
		continue
