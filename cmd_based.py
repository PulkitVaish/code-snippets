...
while done!=1 :
	...
	elif (("run" in p) or ("execute" in p) or ("launch" in p) or ("start" in p) or ("begin" in p) or ("create" in p) or ("initiate" in p) or ("open" in p) or ("activate" in p)) and (("Oracle VB" in p) or ("Virtual Machine" in p) or ("OVB" in p) or ("Virtualization software" in p)):
